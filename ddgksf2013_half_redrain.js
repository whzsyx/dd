...
[task_local]
#半点京豆雨
30 20-23/1 * * * https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/ddgksf2013_half_redrain.js, tag=半点京豆雨, enabled=true

================Loon==============
[Script]
cron "30 20-23/1 * * *" script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/ddgksf2013_half_redrain.js,tag=半点京豆雨

===============Surge=================
 半点京豆雨 = type=cron,cronexp="30 20-23/1 * * *",wake-system=1,timeout=20,script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/ddgksf2013_half_redrain.js

============小火箭=========
 半点京豆雨= type=cron,script-path=https://raw.githubusercontent.com/nianyuguai/longzhuzhu/main/qx/ddgksf2013_half_redrain.js, cronexpr="30 20-23/1 * * *",timeout=200, enable=true
 */
const $ = new Env('半点京豆雨');
let allMessage = '';
let bodyList = {
